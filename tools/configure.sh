...
cp -f -p "${SCRIPT_DIR}/build.sh" "${INSTALL_TOOLS_DIR}/"
...
chmod +x "${INSTALL_TOOLS_DIR}/build.sh" \
  "${INSTALL_TOOLS_DIR}/ac_server_start.sh" \
...
echo ""
echo "======================================================================"
echo "Configuration complete! To compile and install, run:"
echo "  ./tools/build.sh"
echo "  (or manually: cd build && make -j$(($(nproc) - 2)) && make install)"
echo ""
